...
@app.route('/api/slots/feeling', methods=['POST'])
def save_feeling():
    return users.save_feeling()

@app.route('/api/slots/feeling/<id>', methods=['GET'])
def get_feelings(id):
    return users.get_feelings(id)

@app.route('/api/feeling/month/<id>', methods=['GET'])
def get_monthly_feelings(id):
    return users.get_feelings_by_month(id)
